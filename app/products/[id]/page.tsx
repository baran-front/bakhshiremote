...
import RelatedProductsCarousel from "@/components/templates/relatedProductsCarousel";
    ...
    <>
      ...
      <div className="wrapper mt-24 lg:mt-40">
        ...
        {productWithRelatedByCategory.result?.data.relatedProduct?.length ? (
          <RelatedProductsCarousel relatedProducts={productWithRelatedByCategory.result.data.relatedProduct} />
        ) : (
